...
use Carbon\Carbon;
class PurchaseGrowthController extends Controller
{
    public function __invoke(Request $request)
    {
       ...
       if($range === "week"){
        ...
        if($type === "quantity"){
            ...
            $data = Purchase::selectRaw(" SUM(quantity) as data, created_at, extract(".$group_by_column." from created_at) as group_by_column ");
 
         }else{

             $data = Purchase::selectRaw(" SUM(quantity*price) as data, created_at, extract(".$group_by_column." from created_at) as group_by_column ");
         }
